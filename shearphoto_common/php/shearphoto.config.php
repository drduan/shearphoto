...
"proportional"=>1/1,//比例截图，JS端也要相应设置哦，不然系统会给你抱出错误,不设比例填0，如填比例 ：3/4  代表宽和高的比例是3/4
...
"filename"=>uniqid("shearphoto_")."_".mt_rand(100,999)."_"//截好后的图片的文件名字定义！要生成多个文件时 系统会自动在后面补0 1 2  3.....;
);
