...
你也可以加入shearphoto官方QQ群：461550716，分享与我进行交流。
    ...
    shearphoto是属于大家的，shearphoto创造崭新截图环境，希望大家喜欢shearphoto  本程序版本号：shearphoto1.5
                                                        ...
                                                        shearphoto官方QQ群：461550716
                                                                                                              2015年8月7日
                                                                                                                  明哥先生
更新提示：shearphoto1.3时已经加入JAVA版本！需要JAVA的用户请到官网进行下

****************ShearPhoto1.5 免费，开源，兼容目前所有浏览器，纯原生JS和PHP编写*******/
window.webcam = {
          version:"shearphoto1.5",
          // globals
          ...
          get_html:function() {
                    ...
                    if (this.ie) {
                              ...
                              html += '<embed id="webcam_movie" src="' + this.swf_url + '?bugid=1.5" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' + width + '" height="' + height + '" name="webcam_movie" align="middle" allowScriptAccess="always" wmode="opaque" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="' + flashvars + '" />';
                    }
                    this.loaded = false;
                    return html;
          },
